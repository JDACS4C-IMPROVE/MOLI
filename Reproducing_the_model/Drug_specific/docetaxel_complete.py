# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 16:31:04 2023
...
# save results here
save_results_to = '/common/statsgeneral/gayara/MOLI/Docetaxel/results/complete/'
...
ls_marg = [0.5, 1, 1.5]
ls_lr = [0.05, 0.01, 0.001, 0.005, 0.0005, 0.0001]
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCE.values, Y):
        ...
        title = 'Cost Docetaxel iter = {}, fold = {}, mb_size = {},  h_dim[1,2,3] = ({},{},{}), marg = {}, lr[E,M,C] = ({}, {}, {}), epoch = {}, rate[1,2,3,4] = ({},{},{},{}), wd = {}, lrCL = {}, lam = {}'.\
        ...
        title = 'AUC Docetaxel iter = {}, fold = {}, mb_size = {},  h_dim[1,2,3] = ({},{},{}), marg = {}, lr[E,M,C] = ({}, {}, {}), epoch = {}, rate[1,2,3,4] = ({},{},{},{}), wd = {}, lrCL = {}, lam = {}'.\
                      format(iters, k, mbs, hdm1, hdm2, hdm3, mrg, lre, lrm, lrc, epch, rate1, rate2, rate3, rate4, wd, lrCL, lam)        
