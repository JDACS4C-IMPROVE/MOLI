# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 21:09:02 2023
...
save_results_to = '/common/statsgeneral/gayara/MOLI/Erlotinib/results/classifier_only/'
max_iter = 100
torch.manual_seed(42)


GDSCE = pd.read_csv("/common/statsgeneral/gayara/MOLI/Erlotinib/all_data/GDSC_exprs.Erlotinib.eb_with.PDX_exprs.Erlotinib.tsv", 
                    sep = "\t", index_col=0, decimal = ",")
GDSCE = pd.DataFrame.transpose(GDSCE)

GDSCR = pd.read_csv("/common/statsgeneral/gayara/MOLI/Erlotinib/all_data/GDSC_response.Erlotinib.tsv", 
                    sep = "\t", index_col=0, decimal = ",")

PDXE = pd.read_csv("/common/statsgeneral/gayara/MOLI/Erlotinib/all_data/PDX_exprs.Erlotinib.eb_with.GDSC_exprs.Erlotinib.tsv", 
                   sep = "\t", index_col=0, decimal = ",")
PDXE = pd.DataFrame.transpose(PDXE)

PDXM = pd.read_csv("/common/statsgeneral/gayara/MOLI/Erlotinib/all_data/PDX_mutations.Erlotinib.tsv", 
                   sep = "\t", index_col=0, decimal = ".")
PDXM = pd.DataFrame.transpose(PDXM)

PDXC = pd.read_csv("/common/statsgeneral/gayara/MOLI/Erlotinib/all_data/PDX_CNA.Erlotinib.tsv", 
                   sep = "\t", index_col=0, decimal = ".")
PDXC.drop_duplicates(keep='last')
PDXC = pd.DataFrame.transpose(PDXC)
PDXC = PDXC.loc[:,~PDXC.columns.duplicated()]

GDSCM = pd.read_csv("/common/statsgeneral/gayara/MOLI/Erlotinib/all_data/GDSC_mutations.Erlotinib.tsv", 
                    sep = "\t", index_col=0, decimal = ".")
GDSCM = pd.DataFrame.transpose(GDSCM)


GDSCC = pd.read_csv("/common/statsgeneral/gayara/MOLI/Erlotinib/all_data/GDSC_CNA.Erlotinib.tsv", 
                    sep = "\t", index_col=0, decimal = ".")
GDSCC.drop_duplicates(keep='last')
GDSCC = pd.DataFrame.transpose(GDSCC)

PDXR = pd.read_csv("/common/statsgeneral/gayara/MOLI/Erlotinib/all_data/PDX_response.Erlotinib.tsv", 
                       sep = "\t", index_col=0, decimal = ",")
